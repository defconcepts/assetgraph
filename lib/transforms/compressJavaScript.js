...
compressorByName.uglifyJs = function (assetGraph, javaScript, compressorOptions, cb) {
    ...
    setImmediate(function () {
        var uglifyAst = javaScript._parseTree ? uglifyJs.AST_Node.from_mozilla_ast(javaScript.parseTree) : uglifyJs.parse(javaScript.text);
        ...
        cb(null, new assetGraph.JavaScript({
            ...
            parseTree: uglifyAst.to_mozilla_ast()
        }));
    });
};
